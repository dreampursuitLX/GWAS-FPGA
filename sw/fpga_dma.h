...
*
* @brief                  Retrieve number of bytes transferred
*
*                         Pointer to the number of bytes the DMA transferred
*                         to memory.
*
* @param[in]  transfer    Pointer to transfer attribute struct
* @param[out] transfer_bytes Pointer to transferred bytes
*
* @returns                FPGA_OK on success, return code otherwise
*/
fpga_result fpgaDMATransferGetBytesTransferred(fpga_dma_transfer_t transfer, size_t *transfer_bytes);
/**
